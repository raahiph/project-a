...
function message($mobile, $firstname, $lastname, $orderID) {

    $message = "Dear $firstname $lastname, your order ($orderID) has been received. We'll contact you shortly. Thank you!";

    $username = 'FDIStation';
    $password = 'FDI3338855';

    $messages = array('to' => "+960" . $mobile, 'encoding' => 'UNICODE', 'body' => $message);
    ...
    if ($result['http_status'] != 201) {
        ...
        print $result['error'] ? $result['error'] : $result['server_response'];
    } else {
